...
describe('CreditcardsTokenizer', () => {
	...
	describe('tokenize', () => {
		...
		it ('gracefully fails on timeout', () => {
			...
			return tokenizerWithTimeout.tokenize({
                tenantId: someTenantId,
                card
            }).then((intransitToken) => {
    			// Unexpected success
		...
		it ('gracefully fails when network is down', () => {
    		...
    		return tokenizerWithInvalidEndpointUrl.tokenize({
                tenantId: someTenantId,
                card
            }).then((intransitToken) => {
        		// success???
	...
	describe('intransit', () => {
		...
		it ('gracefully fails on timeout', () => {
			...
			return tokenizerWithTimeout.intransit({
                tenantId: someTenantId,
                permanentToken,
                additionalInfo
            }).then((intransitToken) => {
		...
		it ('gracefully fails when network is down', () => {
    		...
    		return tokenizerWithInvalidEndpointUrl.intransit({
                tenantId: someTenantId,
                permanentToken,
                additionalInfo
            }).then((intransitToken) => {
